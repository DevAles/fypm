...
alias taadd-pism-subject='f() { 
    ...
    fypm ta-add "Questions $1" PISM.III Apollonian Objective +Study $2; 
    fypm ta-add "Theory $1" PISM.III Apollonian Objective +Study $2;
    fypm ta-add "AI Active Recall $1" PISM.III Apollonian Objective +Study $2;
}; f'
...
alias taadd-pism-exam-d1='f() { 
    fypm ta-add "$1 - First Day" PISM.III Apollonian Objective +Exams +Study +Math +Biology +Portuguese +Literature
    fypm ta-add "$1 - Correction" PISM.III Apollonian Objective +Exams +Study +Math +Biology +Portuguese +Literature
}; f'
alias taadd-pism-exam-d2='f() { 
    fypm ta-add "$1 - Second Day" PISM.III Apollonian Objective +Exams +Study +Physics +Chemistry +Geography +History
    fypm ta-add "$1 - Correction" PISM.III Apollonian Objective +Exams +Study +Physics +Chemistry +Geography +History
}; f'
